CREATE OR REPLACE PACKAGE REFRESH_APEX_LOGS_pkg 
IS 
...
GRANT DEBUG ON REFRESH_APEX_LOGS_PKG TO ACTIVITY_SUPPORT;

CREATE OR REPLACE PACKAGE BODY REFRESH_APEX_LOGS_pkg 
as 
